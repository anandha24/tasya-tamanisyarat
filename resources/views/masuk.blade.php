    ...
    <div class="container container-fluid" style="min-height: 360px;">
        <div class="row min-vh-25 h-100 position-absolute top-50 start-0 w-100">
            <div class="col-3 col-sm-6 col-lg-8 position-absolute top-50 start-50 translate-middle min-vw-25 w-50 min-vh-25 h-50">
                <form action="{{ url('/login') }}" method="POST" autocomplete="on" id="formulir">
                    <!-- @csrf -->
                    <meta name="csrf-token" content="{{ csrf_token() }}">
                    <table class="table table-hover table-borderless table-responsive caption-top">
                        <caption>Silahkan Login:</caption>
                        <tr>
                            <td>
                                <div class="form-floating mb-3">
                                    <input type="email" name="email_user" class="form-control @error('email_user') error gagal-alert @enderror" id="floatingInput" placeholder="Email" value="{{ old('email_user') }}">
                        ...
                        <tr>
                            <td>
                                <div class="form-floating mb-3">
                                    <input type="password" name="pass_user" class="form-control @error('pass_user') error gagal-alert @enderror" id="floatingPassword" placeholder="Password" value="{{ old('pass_user') }}">
                        ...
                        <tr>
                            <td><input type="submit" value="Login" class="me-2"><input type="reset" id="hapus" value="Reset" class="me-2"><input type="checkbox" name="ingat_saya" id="ingat_saya" value="" <?php if(isset($_POST["ingat_saya"])){?> checked <?php } ?>/><span>Ingat Saya</span></td>
                        </tr>
                        <tr>
                            <td><a class='link-secondary' href="daftar">Register</a>&emsp;<a class='link-secondary' href="lupa">Lupa Password</a></td>
                        </tr>
                    </table>
                </form>
            </div>
