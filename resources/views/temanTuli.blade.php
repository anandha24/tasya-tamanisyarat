...
<body>
<h1>Apa Itu Teman Tuli?</h1>
<br><br>
<div class="konten text-wrap overflow-visible wow fadeInUp" data-wow-delay="0.25s">
<h2>Pengertian Teman Tuli</h2>
<p>
Mungkin kata tuli terdengar kasar tapi sebenarnya orang tuli sendiri lebih suka dengan kata tuli daripada tunarungu karena membuat mereka jadi tidak percaya diri. Mengapa bisa begitu? Kita coba ulik asal-usul katanya dari KBBI.
<br>
<ul>
    <li>tuna : rusak; cacat</li>
    <li>rungu: pendengaran</li>
</ul>
<br>
Sedangkan jika Tuli artinya adalah:
<br>
<ul>
    <li>tuli: tidak dapat mendengar karena rusak pendengarannya</li>
    <li>Tuli: tidak dapat mendengar dan menggunakan bahasa isyarat untuk berkomunikasi</li>
</ul>
<br>
Maka Dari itu teman tuli adalah orang yang tidak dapat mendengar dan berkomunikasi menggunakan bahasa isyarat
</p>
</div>
<br>
<br>
<div class="konten wow fadeInUp" data-wow-delay="0.25s">
<h2 id="bisindo">Apa Itu bahasa Isyarat?</h2>
<p align="left">
    Dilansir dari Wikipedia, Bahasa Isyarat adalah Bahasa Isyarat adalah bahasa yang mengutamakan komunikasi manual, bahasa tubuh, dan gerak bibir, bukannya suara, untuk berkomunikasi. Orang tuli adalah kelompok utama yang menggunakan bahasa ini, biasanya dengan mengkombinasikan bentuk tangan, orientasi dan gerak tangan, lengan, dan tubuh, serta ekspresi wajah untuk mengungkapkan pikiran mereka.
</p>
</div>
</div>
</body>
