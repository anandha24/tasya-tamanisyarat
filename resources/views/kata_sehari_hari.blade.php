    ...
    <br><br><br>
            ...
            <div class="d-flex justify-content-center">
                <div class="card" style="text-align: center; border: none;">
                    <img src="{{ $gambars[$index == null ? '0':$index] }}" width="240px" style="text-align: center;"
                        class="justify-content-center mx-auto" alt="abjad bisindo" width="80">
                    <div class="card-body" id="keterangan">
                        <h4 class="card-text">{{ $katas[$index == null ? '0':$index] }}</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-center" style="padding: 125px;">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu overflow-auto" aria-labelledby="dropdownMenuButton">
                        ...
                        @foreach ($katas as $i)
                        <a class="dropdown-item" href="\kata\{{ $jenis }}\{{ $z }}">{{ $i }}</a>
                        @php
                            $z++;
                        @endphp
                        @endforeach
                    ...
                    <div class="dropdown">
                    <button class="btn btn-secondary overflow-auto dropdown-toggle" type="button" id="jeniskata"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Jenis Kata
                    </button>
                    <div class="dropdown-menu overflow-auto" aria-labelledby="jeniskata">
                        <div class="overflow-auto" style="height: 200px;">
                        <a class="dropdown-item" href="\kata\ganti">Kata Ganti Orang</a>
                        <a class="dropdown-item" href="\kata\sifat">Kata Sifat</a>
                        <a class="dropdown-item" href="\kata\tempat">Kata Tempat</a>
                        <a class="dropdown-item" href="\kata\keluarga">Kata Ganti Keluarga</a>
                        </div>
                    </div>
                </div>
            </div>
