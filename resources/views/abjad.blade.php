            ...
            <div class="d-flex bd-highlight mb-3 ">
                <div  class="me-auto p-2 bd-highlight" style="padding: 100px;">
                    <button id="btn" type="button" class="btn btn-outline-dark btn-lg"
                        style="width: 200px; height: 80px; ""> <a href="\abjad\{{ $index == 0? $index:$index - 1 }}">Back</a></button>
                </div>

                <div  class="p-2 bd-highligh" style="padding: 100px;">
                    <button id="btn" type="button" class="btn btn-outline-dark btn-lg"
                        style="width: 200px; height: 80px; "><a href="\abjad\{{ $index == 25? $index:$index + 1 }}">Next</a></button>
                </div>
            </div>
        </div>
    </div>
