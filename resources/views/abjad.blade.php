    ...
    <h1>BAHASA ISYARAT BISINDO</h1>
            ...
            <div class="d-flex justify-content-center">
                <div class="card" style="text-align: center; border: none;">
                    <img src="{{ $gambars[$index == null ? '0':$index] }}" style="text-align: center;"
                        class="justify-content-center mx-auto" alt="abjad bisindo" width="240">
                    <div class="card-body">
            ...
            <div class="d-flex justify-content-center" style="padding: 125px;">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu overflow-auto" aria-labelledby="dropdownMenuButton">
                        ...
                        @foreach ($huruf as $i)
                        <a class="dropdown-item" href="\abjad\{{ $z }}">{{ $i }}</a>
                        @php
                            $z++;
                        @endphp
                        @endforeach
            ...
            <div class="d-flex bd-highlight mb-3 ">
                <div  class="me-auto p-2 bd-highlight" style="padding: 100px;">
                    <button id="btn" type="button" class="btn btn-outline-dark btn-lg"
                        style="width: 120px; height: 80px; ""> <a href="\abjad\{{ $index == 0? $index:$index - 1 }}">Back</a></button>
                </div>
                ...
                <div  class="p-2 bd-highligh" style="padding: 100px;">
                    <button id="btn" type="button" class="btn btn-outline-dark btn-lg"
                        style="width: 120px; height: 80px; "><a href="\abjad\{{ $index == 25? $index:$index + 1 }}">Next</a></button>
                </div>
            </div>
        </div>
    </div>
